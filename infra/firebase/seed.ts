...
const data = previewSeed.parse({
  ...
  goals: [
    ...
    },
    {
      ...
      progress: 1,
      unit: 'books',
      periodStart: iso(new Date(now.getTime() - 14 * 24 * 60 * 60 * 1000)),
      periodEnd: iso(new Date(now.getTime() + 14 * 24 * 60 * 60 * 1000)),
      sharedWith: ['avery-demo'],
    ...
    },
    {
      ...
      progress: 350,
      unit: 'usd',
      periodStart: iso(new Date(now.getTime() - 30 * 24 * 60 * 60 * 1000)),
      periodEnd: iso(new Date(now.getTime() + 30 * 24 * 60 * 60 * 1000)),
      sharedWith: [],
