    ...
    return (
        <div className="grid grid-cols-3 gap-4">
            <button
                ...
                className="group flex flex-col items-center justify-center gap-2 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-4 shadow-sm transition-all hover:border-brand-200 hover:bg-brand-50 hover:shadow-md"
            >
