            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        onClick={onClose}
                        className={clsx(
                            "fixed inset-0 z-50 bg-slate-900/20 backdrop-blur-sm dark:bg-slate-900/50",
                            overlayClassName
                        )}
                    />
                    ...
                    <motion.div
                        ...
                        exit="exit"
                        className={clsx(
                            "fixed z-50 bg-white shadow-2xl dark:bg-slate-900 border-l border-slate-200 dark:border-slate-800",
