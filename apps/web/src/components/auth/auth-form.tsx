...
export function AuthForm({ onSubmit, onGoogleSignIn, loading, mode }: AuthFormProps) {
      ...
      {onGoogleSignIn && (
        <>
          <button
            ...
            disabled={loading}
            className="flex w-full items-center justify-center gap-2 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-4 py-2 text-sm font-semibold text-slate-900 dark:text-slate-50 hover:bg-slate-50 dark:hover:bg-slate-700 disabled:opacity-60"
          >
